...
//CODE HERE
const empOne = new employee("duvens ","sunday")
...
class manager extends employee{
 ...
 getemployess(){console.log(`${this.Name}manages ${this.employees}`)}
...
//CODE HERE
const manager1 = new manager("winston", "weekday mornings",["cece","schmidt"])
